        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsChangedPart = table.Column<bool>(type: "bit", nullable: false),
                    IsRepairedPart = table.Column<bool>(type: "bit", nullable: false),
                    SellingTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BuyingTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    RiskCost = table.Column<double>(type: "float", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Agreements_AgreementId",
